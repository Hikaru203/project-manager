...
Write-Host "Building and starting all backend services..." -ForegroundColor Yellow
...
Write-Host "`nBackend services are starting in the background." -ForegroundColor Green
